...
export default function AddForm({ categories, skills }: AddFormProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const loadingToast = toast.loading("Menyimpan proyek...");
    ...
    try {
      ...
      await apiClient.postFormData<ProjectFormData>("/api/projects", formData);

      toast.success("Proyek berhasil disimpan!", {
        id: loadingToast,
        description: "Proyek telah ditambahkan ke database.",
      });
    ...
    <div className="p-4 border rounded-xl">
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <Field>
            <FieldLabel htmlFor="projectUrl">Proyek URL</FieldLabel>
            <Input id="projectUrl" type="url" placeholder="https://" value={projectUrl} onChange={(e) => setProjectUrl(e.target.value)} />
        ...
        <Field>
          ...
          <MultiSelect options={skills.map((skill) => ({ id: skill.id, label: skill.name }))} selected={selectedSkills} onChange={setSelectedSkills} placeholder="Pilih skill..." />
