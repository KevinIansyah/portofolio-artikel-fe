...
export function SectionCards() {
  return (
    <div className="*:data-[slot=card]:bg-linear-to-br *:data-[slot=card]:from-primary/20 *:data-[slot=card]:to-card grid grid-cols-1 gap-4 *:data-[slot=card]:shadow-xs md:grid-cols-2 lg:grid-cols-4">
