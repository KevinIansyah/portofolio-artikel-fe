...
import { Facebook, Github, Instagram, Linkedin, Mail, MapPin, MessageCircle, Phone, SendHorizonal } from "lucide-react";
...
import { siteFieldClass, siteWhatsAppUrl } from "@/lib/site-ui";
              ...
              <div className={cn("rounded-2xl border border-border bg-card p-4 shadow-none transition-colors lg:p-6", "hover:border-primary/35")}>
                <div className="flex h-full flex-col gap-8 md:flex-row lg:gap-6">
                  ...
                  <div className="flex-1 space-y-4 lg:space-y-6">
                    <h3 className="text-base font-semibold">{t("home.contact.leaveMessage")}</h3>
                    ...
                    <div className="space-y-4">
                      ...
                      <Textarea className={cn("min-h-25 resize-y py-2.5", siteFieldClass)} name="message" placeholder={t("form.home.contact.placeholder.message")} />
                  ...
                  <div className="flex-1 space-y-4 lg:space-y-6">
                    <h3 className="text-base font-semibold lg:text-lg">{t("home.contact.contactInfo")}</h3>
                    ...
                    <div className="mb-8 space-y-4 md:mb-6">
                      ...
                      <div className="flex items-start gap-2">
                        ...
                        <div className="space-y-1">
                          <p className="font-semibold text-sm">{t("home.contact.address")}</p>
                          <p className="text-muted-foreground text-xs">Jl. Gn. Anyar Jaya Selatan No.25, Gn. Anyar, Kec. Gn. Anyar, Surabaya, Jawa Timur 60294</p>
                        </div>
                      </div>
                      ...
                      <div className="flex items-start gap-2">
                        ...
                        <div className="space-y-1">
                          <p className="font-semibold text-sm">{t("home.contact.phoneNumber")}</p>
                          <p className="text-muted-foreground text-xs">+62 858-1578-7906</p>
                        </div>
                      </div>
                      ...
                      <div className="flex items-start gap-2">
                        ...
                        <div className="space-y-1">
                          ...
                          <p className="text-muted-foreground text-xs">keviniansyah04@gmail.com</p>
                        </div>
                      </div>
                    </div>
